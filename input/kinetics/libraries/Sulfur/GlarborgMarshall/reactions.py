...
entry(
    ...
    kinetics = ThirdBody(
        ...
        efficiencies = {'[H][H]': 0.73, 'O': 12, '[Ar]': 0.38, '[He]': 0.38},
    ),
    longDesc = 
u"""
CON/WES04
...
entry(
    ...
    kinetics = MultiArrhenius(
        arrhenius = [
            ...
            Arrhenius(A=(1.03e+14, 'cm^3/(mol*s)'), n=0, Ea=(11034, 'cal/mol'), T0=(1, 'K')),
        ],
    ),
    longDesc = 
u"""
RAS/GLA07_CO KAP/TROE02
""",
)
...
entry(
    ...
    kinetics = MultiArrhenius(
        arrhenius = [
            ...
            Arrhenius(A=(5.8e+14, 'cm^3/(mol*s)'), n=0, Ea=(9560, 'cal/mol'), T0=(1, 'K')),
        ],
    ),
    longDesc = 
u"""
RAS/GLA07_CO HEL/DRY98
""",
)
...
entry(
    ...
    longDesc = 
u"""
RAS/GLA07_CO (1 bar, 300<T<2000K)
""",
)
...
entry(
    ...
    degeneracy = 1,
    kinetics = Lindemann(
        arrheniusHigh = Arrhenius(A=(1.74e+12, 's^-1'), n=0.31, Ea=(32928, 'cal/mol'), T0=(1, 'K')),
        arrheniusLow = Arrhenius(
...
entry(
    ...
    kinetics = MultiArrhenius(
        arrhenius = [
            Arrhenius(
                A = (4.558e+12, 'cm^3/(mol*s)'),
                n = 0,
                Ea = (-89, 'cal/mol'),
                T0 = (1, 'K'),
            ),
            Arrhenius(
                A = (9.544e+06, 'cm^3/(mol*s)'),
                n = 2,
                Ea = (-89, 'cal/mol'),
                T0 = (1, 'K'),
            ),
